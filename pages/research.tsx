            ...
            <Container>
                ...
                <Grid container>
                    {interests.map((interest, index) => {
                        return (
                            <Grid key={index} item sm={4} xs={6} className={classes.interestGrid}>
                ...
                <div style={{marginTop: '24px'}}>
                    ...
                    You can find one of our earlier collaboration&nbsp;
                    <a target="_blank" rel="noreferrer" href="https://arxiv.org/pdf/2009.01446" className={classes.link}>here</a>.
                </div>
            </Container>
        </Root>
    )
